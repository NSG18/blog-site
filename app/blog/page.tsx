    ...
    <div className="container mx-auto p-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {blogs.map((blog: BlogType, index: number) => (
          <div
            key={index}
            className="shadow-lg rounded-lg overflow-hidden dark:bg-[#1f1d1d]"
          >
            <Image
              className="w-full md:h-64 h-50 object-cover object-top"
              src={blog.imageUrl ? blog.imageUrl : "/sampleblogimg.webp"}
              alt={blog.title}
              width={500}
              height={400}
            />
